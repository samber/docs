...
### Miscellaneous
   ...
   * [Celery exporter](https://github.com/zerok/celery-prometheus-exporter)
   ...
   * [Nomad exporter](https://github.com/samber/nomad-exporter)
   ...
   * [Prometheus inception exporter](https://github.com/samber/prometheus-inception-exporter)
...
practices.
   ...
   * Node: [node-epimetheus](https://github.com/roylines/node-epimetheus)
